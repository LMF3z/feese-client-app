...
const ItemServiceListSwip = ({ serviceItem }) => {
  return (
    <article className='w-full flex flex-col justify-center items-start md:grid md:grid-cols-2 md:grid-rows-1 py-5 pl-5 md:p-5 drop-shadow-2xl bg-secondaryColor'>
